...
export const SkillsItem = [
  ...
  {
    titulo: 'Java Script', Percentual: '30%', icon: <DiJsBadge size={35} color="#fff" />
  },
  {
  ...
  ,
  {
    titulo: 'VB', Percentual: '85%', icon: <DiCode size={35} color="#fff" />
  }
  ,
  {
    titulo: 'MySQL', Percentual: '50%' ,  icon: <DiDatabase size={35} color="#fff" />
  }
]